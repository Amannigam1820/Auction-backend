...
export const endedAuctionCron = () => {
  cron.schedule("*/1 * * * *", async () => {
    ...
    // get auction detail which one ended
    ...
    for (const auction of endedAuction) {
      try {
       ...
       // get highest bidder from bid table
        ...
        if (highestBidder) {
          ...
          console.log("ENDING EMAIL TO HIGHEST BIDDER");
        ...
        return next(console.error(error || "Some error in edned auction cron"))
      }
    }
  });
};
